...
### Philosophers
          ...
          + also in genral overview this project helps managing threads , from the point of creating such structures to the point of managing resources between created thread
            by using mutexes that represents locks that could be used inorder to assign a specific scope in code for a specific thread and arrise that lock to let another thread
                access that data...
